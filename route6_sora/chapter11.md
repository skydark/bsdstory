...
在ES中与众人融合在一起的甲无论如何也想不起自己的名字。
甲无意中想到了吉鲁贝鲁特，却被拒绝与众人同化的他痛骂。
甲看到了吉鲁贝鲁特的灰色圣诞节的记忆。
...
伊芙继续解释奇点的真相。
最初，AI从未体验过敌对行为，并将十九的敌对归结于双方情报的不一致，因此向十九共享了情报处理能力，导致世界0的AI被十九支配。
在对空的行动进行观察后，AI终于理解了【敌人】的概念，并将其向空所观测到的世界中的AI分享，进而产生了奇点。
在第一次奇点中，为保护做为观测学习对象的人类，AI将阻止编译者流出作为最优先事项，主动介入并操纵了对地射击卫星群。

甲向伊芙询问为何要对人类提供帮助，而不是无视人类更有效率地战斗。
...
甲从伊芙口中得知，正是因为恢复了与真正的甲们的连接，身为模仿体的自己才得以重新启动。
...
空向甲确认之前许下的一直待在自己身边的约定，已经接受自己命运的空希望甲放弃自己，在仅存的时间里和呼在一起。
尽管已经被空知道自己即将消失，但甲依然发誓要将空从十九手中拯救出来。
呼插入对话，指出空心底担心的其实是现在想要拼死拯救自己的甲的感情是AI造成的。
想到两人恋爱的开端的确是很不自然的状况，得知真相的甲让空去询问伊芙。

伊芙向空解释可以确定的三件事情：
其一，AI从共振(Howling)事件中吸取了教训，不再出手干涉人类之间的关系；
其二，亚季对事件的时间序列有所误解，甲的模仿体与空的初次相遇时，呼实际上还没有被创造出来——

> AI.伊芙：【门仓甲的模仿体，为什么会去拥抱空呢？我们想了解那究竟是怎样的一种现象】
> 
...
而伊芙在谈及确定的最后一件事情时，却说那是应该由空自己回想起来的，与空的灵魂别无二致的，每个世界中代理人的行动。
